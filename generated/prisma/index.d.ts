...
export namespace Prisma {
  ...
  */
  ...
  export type CitationOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "text" | "author" | "createAt", ExtArgs["result"]["citation"]>
  ...
  interface CitationFieldRefs {
    ...
    readonly createAt: FieldRef<"Citation", 'DateTime'>
  }
  ...
  export type CitationWhereInput = {
    ...
    createAt?: DateTimeFilter<"Citation"> | Date | string
  }
  ...
  export type CitationScalarWhereWithAggregatesInput = {
    ...
    createAt?: DateTimeWithAggregatesFilter<"Citation"> | Date | string
  }
